...
class Sitemap extends Model
{
     ...
     */
    public $table = 'bmut_utils_sitemap';
    ...
    public function getTypeOptions()
    {
        ...
        /*
            ...
            ```
            Event::listen('bmut.sitemap.types', function () {
                return ['pages' => 'Páginas'];
            });
            ```
         */
        $types = Event::fire('bmut.sitemap.types');
        if (is_array($types)) {
        ...
        try {
            if ($items->count()) {
                foreach ($items as $item) {
                    ...
                    $extraItems = Event::fire('bmut.sitemap.generate', [$item, $theme]);
