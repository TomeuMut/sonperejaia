...
class Settings extends Model
{
    ...
    // A unique code
    public $settingsCode = 'bmut_utils_config';

    // Reference to field configuration
    public $settingsFields = 'fields.yaml';

    public $attachOne = [
        'robots' => ['Bmut\Utils\Classes\Helpers\File', 'delete' => true],
        'sitemap' => ['Bmut\Utils\Classes\Helpers\File', 'delete' => true],
        'broken_image' => ['Bmut\Utils\Classes\Helpers\File', 'delete' => true]
    ];
