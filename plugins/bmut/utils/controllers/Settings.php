...
class Settings extends \System\Controllers\Settings
{
    ...
    {
        parent::__construct();
        BackendMenu::setContext('bmut.utils', 'main-seo', 'inner-settings');
    }
    ...
    public function update($author = 'Bmut', $plugin = 'Utils', $code = 'settings')
    {
    ...
    public function update_onSave($author = 'Bmut', $plugin = 'Utils', $code = 'settings')
    {
